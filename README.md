<p align="center">
  <picture>
    <img src="docs/assets/geminicon-readme-hero.svg" alt="Geminicon — a production-minded Gemini Antigravity agent harness for new and established repositories" width="100%">
  </picture>
</p>

<p align="center">
  <a href="https://github.com/bnet47/geminicon/actions/workflows/ci.yml"><img src="https://github.com/bnet47/geminicon/actions/workflows/ci.yml/badge.svg" alt="Template CI"></a>
...
<p align="center">
  ...
  ·
  <a href="https://bnet47.github.io/geminicon/repo-template-playbook.html"><strong>Explore the visual playbook</strong></a>
  ·
  <a href="#06--security-and-authority"><strong>Review the security model</strong></a>
</p>

> [!IMPORTANT]
> Geminicon improves the development process; it does not make an unfinished application production-ready by itself. Every project must still supply and verify its own architecture, security, data, operations, and release evidence.
...
| **[Create from the GitHub template →](https://github.com/new?template_name=geminicon&template_owner=bnet47)** | **[Read the adoption guide →](docs/gemini.md#adoption-diagnostics-and-updates)** |

Geminicon is intentionally not an application starter or a framework opinion. It gives Gemini Antigravity durable operating rules, progressive workflows, canonical checks, and clear authority boundaries—then leaves product and technology choices to the evidence in the project.
...
<p align="center">
  <picture>
    <img src="docs/assets/geminicon-operating-model.svg" alt="Geminicon operating model: context, route, verify, then cross an explicit authority boundary" width="100%">
  </picture>
</p>
...
1. Select **[Use this template](https://github.com/new?template_name=geminicon&template_owner=bnet47)** and create a repository.
2. Open Gemini Antigravity at the repository root.
3. Review `AGENTS.md` and `.gemini/config.toml` before trusting the project configuration.
...
Keep Geminicon and the target repository separate, then begin with a read-only inspection:

```bash
python scripts/security_scan.py
```

Inspection does not write. After reviewing conflicts and project-owned requirements, an explicit adoption copies only absent managed or merge files and records baseline hashes; it never replaces existing content.
...
|---|---|---|---|
| **Adopt** | An established repository needs the harness | `/adopt-geminicon` | Reviewed compatibility plan and conflicts |
...
| Situation | Use |
|---|---|
| Established repository needs Geminicon | `/adopt-geminicon` |
...
Skills are routing tools, not mandatory ceremony. Gemini Antigravity may select one automatically; name one when you want that exact workflow.
...
> **Want the whole system at a glance?** The [interactive visual playbook](https://bnet47.github.io/geminicon/repo-template-playbook.html) maps every lifecycle stage, repository skill, safety boundary, example prompt, and capability tier. Its standalone source remains in [`docs/repo-template-playbook.html`](docs/repo-template-playbook.html) for local and offline use.

## 06 — Security and authority

Geminicon treats safety as a chain of independent controls, not a single prompt.
...
| **Git and CI checks** | Offer opt-in local gates and repeat verification with credential scanners |
...
Geminicon reduces recurring context without weakening engineering work:
...
├── docs/                     # Gemini guide, patterns, and visual playbook
...
|---|---|
| [Interactive visual playbook](https://bnet47.github.io/geminicon/repo-template-playbook.html) | [Security policy](SECURITY.md) |
| [Start a project](START_HERE.md) | [Maintainer and release guide](docs/maintainers.md) |
| [Gemini configuration](docs/gemini.md) | [Contributing](CONTRIBUTING.md) |
...
- Gemini Antigravity opened at the repository root.
...
Questions and reproducible problems belong in [GitHub Issues](https://github.com/bnet47/geminicon/issues) after checking the [support guidance](SUPPORT.md). Security vulnerabilities must follow the [private reporting process](SECURITY.md). Contributions are welcome under [CONTRIBUTING.md](CONTRIBUTING.md) and the [Code of Conduct](CODE_OF_CONDUCT.md).

Geminicon is maintained by [@bnet47](https://github.com/bnet47) and released under the [MIT License](LICENSE).
